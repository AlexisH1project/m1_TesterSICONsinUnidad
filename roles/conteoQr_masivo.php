	...
	while($rowCarpDocs=mysqli_fetch_row($conectar)){ 
		...
		if(file_exists($from.$rowCarpDocs[2]."\\".$curp."_".$rowCarpDocs[2].".PDF")){
			if($rowCarpDocs[2] == "FMP"){
				continue;
			}else if($rowCarpDocs[2] == "ACTA" OR	$rowCarpDocs[2] == "BAN" OR	$rowCarpDocs[2] == "CED" OR	$rowCarpDocs[2] == "CONS" OR	$rowCarpDocs[2] == "CURP" OR $rowCarpDocs[2] == "IDE" OR $rowCarpDocs[2] == "RFC"){
