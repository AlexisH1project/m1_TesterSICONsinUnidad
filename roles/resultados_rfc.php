...
<?php
   ...
   /*   $value = array( 
    ...
    if($request == 4){
        ...
        $consulta3 = "SELECT id_movimiento, codigoMovimiento, vigenciaDel, anio, qnaDeAfectacion, unidad, doc67 FROM fomope WHERE rfc='$row[1]' AND color_estado != 'negro' AND color_estado != 'negro1'";
        $resultado3 = mysqli_query($conexion,$consulta3);
       // $row2 = mysqli_fetch_row($resultado3); 
       // $rowCombinado = array_merge($row,$row2);
        //array("data1" => $row, "data2" => $row2)
