...
/*
			...
			$sql = "UPDATE fomope SET color_estado='amarillo', usuario_name = '$usuarioEdito', fechaAutorizacion = '$row[0] - $usuarioEdito', analistaCap = '$analista' WHERE id_movimiento = '$idFomope'" ;
