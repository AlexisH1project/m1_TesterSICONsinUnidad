...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-06-2020 a las 03:08:35
...
CREATE TABLE `fomope_qr` (
  ...
  `num_varcharerior` varchar(5) COLLATE utf8_spanish_ci NOT NULL,
  ...
  `tex_con` varchar(255) COLLATE utf8_spanish_ci NOT NULL
