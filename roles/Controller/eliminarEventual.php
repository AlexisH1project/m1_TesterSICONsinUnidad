	...
	if($elBoton == "Eliminar"){
		...
		$tiempo ="select curTime()";
			 ...
			 if ($resultHoy = mysqli_query($conexion,$hoy) AND $resultTime = mysqli_query($conexion,$tiempo)) {
				 ...
				 $sql2 = "INSERT INTO historial_qr (id_movimiento_qr,usuario,fechaMovimiento,horaMovimiento) VALUES ('$idFomope','$usuarioSegimiento','$row[0]','$row2[0]')";
				...
				$sqlEliminar = "UPDATE fomope_qr SET estatus = 'rojo' WHERE id_movimiento_qr = '$idFomope'";
...
*/
				if ($id_rol1 == 1) {
				  ...
				  echo "<script>window.location.href = '../LuluEventuales.php?usuario_rol=$usuarioSegimiento'</script>";
				}
			}
	}else {
