	...
	<head>
		...
		function elimRequeridos() {
				...
				$.ajax({
					...
					url:   'resultado_movName_qr.php', //archivo que recibe la peticion
					...
					success:  function (data) { //una vez que el archivo recibe el request lo procesa y lo devuelve
							...
							document.getElementById("rfcL_1").value = infEmpleado[0].curp;
					}
      			});
			...
			var newList = [];
				...
				function  enviarList() {
						...
						$.ajax({
								...
								url:   'Controller/insertListDoc_qr.php', //archivo que recibe la peticion
								type:  'post', //método de envio
								data: formData,
								cache: false,
								contentType: false,
