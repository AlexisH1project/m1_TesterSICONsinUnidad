...
function showFiles($from){
	...
	$nameCarpetaOTRO= explode("\\Archivos\\", $from);
	$to = '../roles/Controller/DOCUMENTOS_RES/'.$nameCarpetaOTRO[1];
    $nameCarpetaSICON= explode("/Controller/DOCUMENTOS_RES/", $to);
...
/*
												...
												;  */
												if($nameCarpetaSICON[1] == 'ACTA' || $nameCarpetaSICON[1] == 'BAN' || $nameCarpetaSICON[1] == 'CED' || $nameCarpetaSICON[1] == 'CURP' || $nameCarpetaSICON[1] == 'CV' || $nameCarpetaSICON[1] == 'DOM' || $nameCarpetaSICON[1] == 'IDE' || $nameCarpetaSICON[1] == 'INEX' || $nameCarpetaSICON[1] == 'MANIF' || $nameCarpetaSICON[1] == 'N_EMP' || $nameCarpetaSICON[1] == 'N_INHAB' || $nameCarpetaSICON[1] == 'N_JUI' || $nameCarpetaSICON[1] == 'RFC'){
													$existeRFC = -1;
												...
												;  
											 	...
											 	$soloNombre = explode(".", $nombreCompSICON);
													...
													// ---> ahora detectamos en que qna nos encontramos
														 $queryQna = "SELECT * FROM m1ct_fechasnomina WHERE estadoActual = 'abierta'";
														 if($SiQueryQna = mysqli_query($conexion, $queryQna)){
															 $rowFechas = mysqli_fetch_row($SiQueryQna);
